...
<div class="card">
    <div class="card-header d-flex flex-column flex-md-row justify-content-between align-items-md-center gap-2">
        <h5 class="mb-0">Danh sách template</h5>
        <div class="d-flex gap-2 flex-column flex-md-row">
            <a href="<?php echo esc_url(home_url('/aerp-implementation-templates/?action=add')); ?>" class="btn btn-primary">
    ...
    <div class="card-body">
        ...
        <?php if ($message) {
            ...
            delete_transient('aerp_implementation_template_message');
        } ?>
        <div id="aerp-implementation-template-table-wrapper">
            <?php $table->render(); ?>
        </div>
