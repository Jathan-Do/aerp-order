        ...
        <form class="aerp-order-form" method="post" enctype="multipart/form-data">
            ...
            <div class="row">
                    ...
                    <div id="content-container">
                        <div class="row mb-2 content-row">
                            ...
                            <div class="col-md-6 mb-2">
                                ...
                                <textarea class="form-control" name="content_lines[0][requirement]" rows="2" placeholder="Mô tả yêu cầu của khách hàng..."></textarea>
                            </div>
                            <div class="col-md-6 mb-2">
                                <label class="form-label">Nội dung triển khai</label>
                                <textarea class="form-control" name="content_lines[0][implementation]" rows="2" placeholder="Nội dung triển khai chi tiết..."></textarea>
                            </div>
                            <div class="col-md-3">
                                <label class="form-label">Đơn giá</label>
                                <input type="number" class="form-control content-unit-price" name="content_lines[0][unit_price]" placeholder="0" min="0" step="0.01" value="0">
                            </div>
                            <div class="col-md-3">
                                <label class="form-label">Số lượng</label>
                                <input type="number" class="form-control content-quantity" name="content_lines[0][quantity]" placeholder="1" min="0" step="0.01" value="1">
                            </div>
                            <div class="col-md-3">
                                <label class="form-label">Thành tiền</label>
                                <input type="text" class="form-control content-total-price" name="content_lines[0][total_price]" placeholder="0" readonly>
                            </div>
                            <div class="col-md-3">
                                <label class="form-label">Bảo hành</label>
                                <input type="text" class="form-control" name="content_lines[0][warranty]" placeholder="VD: 12 tháng" value="1 tháng">
                            </div>
                    ...
                    <div id="device-return-table">
                        <div class="row mb-2 device-return-row">
                            <div class="col-md-4">
                                ...
                                <select class="form-select received-device-select" style="width:100%" name="device_returns[0][device_id]"></select>
                            </div>
                            <div class="col-md-3">
                                <label class="form-label">Ngày trả</label>
                                <input type="date" class="form-control" name="device_returns[0][return_date]" value="<?php echo esc_attr(date('Y-m-d')); ?>">
                            </div>
                            <div class="col-md-4">
                                <label class="form-label">Ghi chú</label>
                                <input type="text" class="form-control" name="device_returns[0][note]" placeholder="Ghi chú">
                            </div>
                            <div class="col-md-1 mt-2 d-flex align-items-end">
                    ...
                    <div id="order-items-container">
                        <div class="row order-item-row">
                            ...
                            <div class="col-md-2 mb-2 d-flex align-items-end">
                                <div class="w-100">
                                    <label class="form-label">Số lượng</label>
                                    <input type="number" class="form-control" name="order_items[0][quantity]" placeholder="Số lượng" min="0" step="0.01">
                                </div>
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <textarea class="form-control" id="note" name="note" rows="2" placeholder="Nội dung ghi chú"></textarea>
                </div>
                <div class="col-md-6 mb-3">
    ...
    jQuery(document).ready(function($) {
        ...
        $('#add-content').on('click', function() {
            let row = `<div class="row mb-2 content-row">
                ...
                <div class="col-md-3">
                    <label class="form-label">Số lượng</label>
                    <input type="number" class="form-control content-quantity" name="content_lines[${contentIndex}][quantity]" placeholder="1" min="0" step="0.01" value="1">
                </div>
                <div class="col-md-3">
                    <label class="form-label">Thành tiền</label>
                    <input type="text" class="form-control content-total-price" name="content_lines[${contentIndex}][total_price]" placeholder="0" readonly>
                </div>
                <div class="col-md-3">
                    <label class="form-label">Bảo hành</label>
                    <input type="text" class="form-control" name="content_lines[${contentIndex}][warranty]" placeholder="VD: 12 tháng" value="1 tháng">
                </div>
                <div class="col-md-12 mt-2">
                    <button type="button" class="btn btn-outline-danger remove-content">Xóa dòng</button>
                </div>
