...
$access_conditions = [
    ...
    aerp_user_has_permission($user_id,'product_view'),
...
$message = get_transient('aerp_product_message');
ob_start();
?>
...
if (function_exists('aerp_render_breadcrumb')) {
    aerp_render_breadcrumb([
        ...
        ['label' => 'Quản lý sản phẩm kho']
    ]);
}
?>
<div class="card">
    <div class="card-header d-flex flex-column flex-md-row justify-content-between align-items-md-center gap-2">
        <h5 class="mb-0">Danh sách sản phẩm kho</h5>
        <div class="d-flex gap-2 flex-column flex-md-row">
            <a href="<?php echo esc_url(home_url('/aerp-products/?action=add')); ?>" class="btn btn-primary">
    ...
    <div class="card-body">
        <?php if ($message) {
            ...
            delete_transient('aerp_product_message');
        } ?>
        <div id="aerp-product-table-wrapper">
            <?php $table->render(); ?>
        </div>
