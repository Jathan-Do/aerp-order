...
ob_start();
$message = get_transient('aerp_supplier_message');
?>
...
<div class="card">
    ...
    <div class="card-body">
        <?php if ($message) {
            ...
            delete_transient('aerp_supplier_message');
        } ?>
        <div id="aerp-supplier-table-wrapper">
            <?php $table->render(); ?>
        </div>
        <a href="<?php echo home_url('/aerp-products'); ?>" class="btn btn-outline-secondary" style="width: fit-content;">
