...
class AERP_Inventory_Log_Table extends AERP_Frontend_Table
{
    public function __construct()
    {
        parent::__construct([
            ...
            'sortable_columns' => ['id', 'product_id', 'type', 'quantity', 'created_by', 'created_at'],
            'searchable_columns' => [],
            'primary_key' => 'id',
            'per_page' => 10,
            'actions' => [],
            ...
            'ajax_action' => 'aerp_inventory_filter_logs',
    ...
    {
        return $item->type === 'import' ? '<span class="badge bg-success">Nhập kho</span>' : '<span class="badge bg-danger">Xuất kho</span>';
    }
